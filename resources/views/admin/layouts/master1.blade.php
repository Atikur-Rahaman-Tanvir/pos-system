                            ...
                            <div class="white_card_header ">
                                <div class="box_header m-0">
                                    <ul class="nav  theme_menu_dropdown">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{ asset('assets') }}/#">Analytics</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('assets') }}/#">Cryptocurrency</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('assets') }}/#">Campaign</a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                                href="{{ asset('assets') }}/#" role="button" aria-haspopup="true"
                                                aria-expanded="false">More</a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ asset('assets') }}/#"> Ecommarce
                                                    Analytics</a>
                                                <a class="dropdown-item" href="{{ asset('assets') }}/#"> Sales</a>
                                    ...
                                    <div class="button_wizerd">
                                        <a href="{{ asset('assets') }}/#" class="white_btn mr_5">ToDo</a>
                                        <a href="{{ asset('assets') }}/#" class="white_btn">Settings</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="page_title_right">
                                <div class="dropdown CRM_dropdown  mr_5 mb_10">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ asset('assets') }}/#">Today</a>
                                        <a class="dropdown-item" href="{{ asset('assets') }}/#">This Week</a>
                                        <a class="dropdown-item" href="{{ asset('assets') }}/#">Last week</a>
                                    </div>
                                </div>
                                <a href="{{ asset('assets') }}/#" class="white_btn mb_10">Export</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8">
                        <div class="white_card   card_height_100 mb_30">
                            <div class="white_card_header">
                                <div class="box_header m-0 flex-wrap">
                                    ...
                                    <div class="view_btns">
                                        <a href="{{ asset('assets') }}/#"
                                            class="mr_5 mb_10  small_blue_btn active">All</a>
                                        <a href="{{ asset('assets') }}/#"
                                            class="mr_5 mb_10  small_blue_btn active">1M</a>
                                        <a href="{{ asset('assets') }}/#" class="mr_5 mb_10  small_blue_btn">6M</a>
                                        <a href="{{ asset('assets') }}/#" class="mr_5 mb_10  small_blue_btn">1Y</a>
                                        <a href="{{ asset('assets') }}/#" class="mr_5 mb_10  small_blue_btn">YTD</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="header_more_tool">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="{{ asset('assets') }}/#"> <i
                            ...
                            <div class="white_card_body">
                                ...
                                <div class="social_media_list">
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="{{ asset('assets') }}/img/currency/1.svg"
                                                alt=""> Bitcoin</span>
                                    ...
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="{{ asset('assets') }}/img/currency/2.svg"
                                                alt=""> Litecoin</span>
                                        <span class="earning_amount">
                                            <h4>0.000242 BTC</h4>
                                            <p>0.125 USD</p>
                                    ...
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="{{ asset('assets') }}/img/currency/3.svg"
                                                alt=""> Ripple</span>
                                        <span class="earning_amount">
                                            <h4>0.000242 BTC</h4>
                                            <p>0.125 USD</p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="{{ asset('assets') }}/img/currency/1.svg"
                                                                alt=""> Bitcoin </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="{{ asset('assets') }}/img/currency/2.svg"
                                                                alt=""> Bitcoin </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="{{ asset('assets') }}/img/currency/4.svg"
                                                                alt=""> Bitcoin </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="{{ asset('assets') }}/img/currency/3.svg"
                                                                alt=""> Bitcoin </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                ...
                                <div class="recent_transfer_wrapper">
                                    <div class="transfer_thumb_conatnt">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="{{ asset('assets') }}/img/transfer/1.png"
                                                            alt="">
                                                    </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="{{ asset('assets') }}/img/transfer/2.png"
                                                            alt="">
                                                    </div>
                                                    <h5 class="f_s_14 f_w_400 mb-0">Samuel</h5>
                                                    <p class="f_s_11 f_w_400">@samuel15</p>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="{{ asset('assets') }}/img/transfer/3.png"
                                                            alt="">
                                                    </div>
                                                    <h5 class="f_s_14 f_w_400 mb-0">Samuel</h5>
                                                    <p class="f_s_11 f_w_400">@samuel15</p>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="{{ asset('assets') }}/img/transfer/4.png"
                                                            alt="">
                                                    </div>
                                                    <h5 class="f_s_14 f_w_400 mb-0">Samuel</h5>
                                                    <p class="f_s_11 f_w_400">@samuel15</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <a href="{{ asset('assets') }}/#" class="btn_1 w-100">Send Money</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="white_card_header">
                                        <div class="box_header m-0">
                                            ...
                                            <div class="erning_btn d-flex">
                                                ...
                                                <a href="{{ asset('assets') }}/#"
                                                    class="small_blue_btn radius_0">Week</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="white_card_body">
                                            ...
                                            <div class="QA_table mb-0">
                                                ...
                                                <table class="table lms_table_active2  ">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="{{ asset('assets') }}/img/currency/1.svg"
                                                                    alt=""> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                            <td>$25.00</td>
                                                            <td><a href="{{ asset('assets') }}/#"
                                                                    class="status_btn pending_btn">Pending</a></td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="{{ asset('assets') }}/img/currency/2.svg"
                                                                    alt=""> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                        ...
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="{{ asset('assets') }}/img/currency/3.svg"
                                                                    alt=""> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                        ...
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="{{ asset('assets') }}/img/currency/4.svg"
                                                                    alt=""> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                ...
                                <div class="news_widget_wrap">
                                    <div class="single_news mb_20">
                                        <div class="thumb mb_20">
                                            <a href="{{ asset('assets') }}/#"><img class="img-fluid"
                                                    src="{{ asset('assets') }}/img/news/1.svg" alt=""></a>
                                        </div>
                                        <a href="{{ asset('assets') }}/#">
                                    ...
                                    <div class="single_news mb_20">
                                        <div class="thumb mb_20">
                                            <a href="{{ asset('assets') }}/#"><img class="img-fluid"
                                                    src="{{ asset('assets') }}/img/news/2.svg" alt=""></a>
                                        </div>
                                        <a href="{{ asset('assets') }}/#">
                                            <p class="f_s_18 f_w_400">Aorem psum dolor sit amet, consect
                                                adipisci Quisque scelerisq.</p>
